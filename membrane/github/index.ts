...
export const Root = {
  ...
  sendTokenExpirationNotice: async () => {
    await nodes.email.send({
      subject: "github driver token expiration notice",
      body: "The github personal access token that Pete configured in the github driver will expire on Oct 6, 2024"
    })
  },
  users: () => ({}),
  search: () => ({}),
