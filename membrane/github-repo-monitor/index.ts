...
/**
 * TODO:
 * 1. Test the `check` action by manually invoking it: press the "Invoke ►" button above the fn signature.
 * 2. Set up a cron:
 *    a. Select `github-repo-release-monitor` in the Navigator (left sidebar).
 *    b. Click the clock icon then "Invoke at schedule...", e.g. `0 0 9 * * 2-6` for 9am Mon-Fri.
 */
export async function check() {
  ...
  if (state.lastReleaseId !== id) {
    ...
    /**
     * TODO:
     * Update the `vscode` program connection to a repo of your choosing:
